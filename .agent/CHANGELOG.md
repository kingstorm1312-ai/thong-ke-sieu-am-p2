...
## [Unreleased]
### Added (Thêm mới)
- **Hiển thị trực quan:** Thêm cụm widget (Expander) "⏱️ Thông số đối chiếu Đồng hồ / Vật tư" tại tab "Phân Tích Cuộn" để show chỉ số mở rộng của cuộn đang chọn (cả ở App cũ & mới).
